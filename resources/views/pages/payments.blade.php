@section('meta_og_title',trans('payments.title'))
	...
	<div class="container">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb py-2 py-lg-3">
				...
				<li class="breadcrumb-item active" aria-current="page">{{trans('payments.title')}}</li>
			</ol>
		</nav>
	</div>
</section>
...
<section class="section bg-white py-5 ">
		<div class="container">
			<h2 class="h1 mb-4 mb-md-5">{{trans('payments.title')}}</h2>
			<div class="accordion accordion-style-1" id="accordion1">
				<div class="row">
					{!!trans('payments.content')!!}
				</div>
			</div>
		</div>
	</section>
